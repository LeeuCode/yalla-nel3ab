...
if (isset($_POST)) {
    ...
    $morning_periods_price = input_exist('morning_periods_price');
    $night_periods_price = input_exist('night_periods_price');
    ...
    update_post_meta($post_id, 'morning_periods_price', $morning_periods_price);
    update_post_meta($post_id, 'night_periods_price', $night_periods_price);
    ...
    get_template_part(
        ...
        null,
        array(
            'msg' => __('تم تعديل بيانات الملعب بنجاح!', 'qeema'),
            'icon' => 'success',
