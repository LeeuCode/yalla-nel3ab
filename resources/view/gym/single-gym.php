...
<div class="container">
    <form hx-post="<?php echo site_url('booking/store/'); ?>" hx-swap="innerHTML" hx-on::before-request="showLoad()" hx-on::after-request="this.reset()" hx-target="#message" class="row">
        ...
        ?>
            <div class="col-12">
                <h6 class="fw-bold small mb-2"><?php echo __('عنوان الجيم', 'qeema'); ?></h6>
        ...
        ?>
            <div class="col-12">
                <h6 class="fw-bold small my-3"><?php echo __('موقع الجيم', 'qeema'); ?></h6>
        ...
        <div
            ...
            <p class="text-danger fw-bold mb-0"><span class="price"><?php echo 00; ?></span> ج.م</p>
        </div>
    </form>
</div>
