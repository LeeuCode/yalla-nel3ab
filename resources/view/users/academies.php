                ...
                <div class="col-12" <?php echo (get_next_posts_page_link($query->max_num_pages)) ? $t : ''; ?>>
                    <div class="mb-3 position-relative shadow p-3 rounded-2">
                        ...
                        <div class="d-grid mt-3">
                            <a hx-get="<?php echo site_url('user/academy/edit/' . $post->ID . '/'); ?>" hx-swap="innerHTML show:top" hx-trigger="click" hx-target=".app" hx-on::before-request="showLoad()" class="btn btn-danger">
