            ...
            ?>
                <div class="col-12">
                    <div class="shadow-sm mb-3 position-relative">
                        ...
                        <a hx-get="<?php echo site_url('playgrounds/' . $section->term_id . '/'); ?>" hx-swap="innerHTML transition:true show:top" hx-target="closest .app" hx-trigger="click" hx-on::before-request="showLoad()" class="z-index-2 stretched-link"></a>
                    </div>
                </div>
            <?php endforeach; ?>
        </div>
